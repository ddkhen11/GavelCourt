...
- [x] 🚦 `/security-review` (auth tokens, bid validation) — _gate: no open high-severity findings_
- [x] `README.md`: setup + dev commands — _gate: a fresh clone can follow it to a running app_
